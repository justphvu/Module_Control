...
KEY=0;
    ...
    %% Канал высоты
    kP=1.0E00;    kI=1.0E-1;    kD=1.0E00;
    sLIM=[-100;100];
    [DF,SDH,dDHf]=FCONTROL(DH,DH0,SDH0,dDHf0,sLIM,kP,kI,kD);
    DH0=DH; SDH0=SDH;   dDHf0=dDHf;

    %% Канал тангажа
    kP=5.0E00;    kI=5.0E-1;    kD=1.0E00;
    sLIM=[-100;100]*pi/180;
    [DMz,SDTET,dDTETf]=FCONTROL(DTET,DTET0,SDTET0,dDTETf0,sLIM,kP,kI,kD);
    DTET0=DTET; SDTET0=SDTET;   dDTETf0=dDTETf;

    %% Канал крена
    kP=5.0E00;    kI=5.0E-1;    kD=1.0E00;
    sLIM=[-100;100]*pi/180;
    [DMx,SDGAM,dDGAMf]=FCONTROL(DGAM,DGAM0,SDGAM0,dDGAMf0,sLIM,kP,kI,kD);
    DGAM0=DGAM; SDGAM0=SDGAM;   dDGAMf0=dDGAMf;

    %% Канал курса
    kP=5.0E00;    kI=5.0E-1;    kD=1.0E00;
    sLIM=[-10;10]*pi/180;
    [DMy,SDPSI,dDPSIf]=FCONTROL(DPSI,DPSI0,SDPSI0,dDPSIf0,sLIM,kP,kI,kD);
...
%     end
    ...
    DUSQ1=DF/(4*kT)+DMz/(2*kT*Lq)+DMy/(4*kM);
    DUSQ2=DF/(4*kT)-DMx/(2*kT*Lq)-DMy/(4*kM);
    DUSQ3=DF/(4*kT)-DMz/(2*kT*Lq)+DMy/(4*kM);
    DUSQ4=DF/(4*kT)+DMx/(2*kT*Lq)-DMy/(4*kM);
