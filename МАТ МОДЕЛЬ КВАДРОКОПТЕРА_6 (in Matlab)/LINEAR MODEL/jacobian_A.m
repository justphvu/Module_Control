...
function A_reduce = jacobian_A( state_eq, control_eq)
    ...
    for j = 1 : no_col
        ...
        for i = 1 : no_row
            tol = 0.1;
            a0 = fdx( state_eq, control_eq, row(i), column(j), dv0 );
            a1 = fdx( state_eq, control_eq, row(i), column(j), dv1 );
            a2 = fdx( state_eq, control_eq, row(i), column(j), dv2 );
            ...
            while k <= 100 
                ...
                if new_dv <= min_dv * state_eq( column(j) )
                    ...
                    a2 = a1;
                    a1 = a0;
                    a0 = fdx( state_eq, control_eq, row(i), column(j), new_dv );
                    b1 = b0;
    ...
    %-----------------------------------------
    % state = [ продольное движение и  боковое движение];
    ...
    answer_A( 3, : ) = answer( 6, : );
    answer_A( 4, : ) = answer( 9, : );
    answer_A( 5, : ) = answer( 10, : );
    answer_A( 6, : ) = answer( 11, : );
     
    %% Боковое движение
    answer_A( 7, : ) = answer( 3, : );
    answer_A( 8, : ) = answer( 4, : );
    answer_A( 9, : ) = answer( 5, : );
    answer_A( 10, : ) = answer( 7, : );
    answer_A( 11, : ) = answer( 8, : );
    answer_A( 12, : ) = answer( 12, : );
    ...
    answer( :, 3 ) = answer_A( :, 6 );
    answer( :, 4 ) = answer_A( :, 9 );
    answer( :, 5 ) = answer_A( :, 10 );
    answer( :, 6 ) = answer_A( :, 11 );
    %% Боковое движение
    answer( :, 7 ) = answer_A( :, 3 );
    answer( :, 8 ) = answer_A( :, 4 );
    answer( :, 9 ) = answer_A( :, 5 );
    answer( :, 10 ) = answer_A( :, 7 );
    answer( :, 11 ) = answer_A( :, 8 );
    answer( :, 12 ) = answer_A( :, 12 );
