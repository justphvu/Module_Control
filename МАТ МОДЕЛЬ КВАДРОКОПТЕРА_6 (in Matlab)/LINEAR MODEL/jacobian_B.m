...
function B_reduce = jacobian_B( state_eq, control_eq, xcg )
...
for j = 1 : no_col
    ...
    for i = 1 : no_row
        tol = 0.1;
        a0 = fdu( state_eq, control_eq, row(i), column(j), dv0 );
        a1 = fdu( state_eq, control_eq, row(i), column(j), dv1 );
        a2 = fdu( state_eq, control_eq, row(i), column(j), dv2 );
        ...
        while k <= 100 
            ...
            if new_dv <= min_dv * state_eq( column(j) )
                ...
                a2 = a1;
                a1 = a0;
                a0 = fdu( state_eq, control_eq, row(i), column(j), new_dv );
                b1 = b0;
...
answer_B( 3, : ) = answer( 6, : );
answer_B( 4, : ) = answer( 9, : );
answer_B( 5, : ) = answer( 10, : );
answer_B( 6, : ) = answer( 11, : );
%% Боковое движение
answer_B( 7, : ) = answer( 3, : );
answer_B( 8, : ) = answer( 4, : );
answer_B( 9, : ) = answer( 5, : );
answer_B( 10, : ) = answer( 7, : );
answer_B( 11, : ) = answer( 8, : );
answer_B( 12, : ) = answer( 12, : );
