...
%     end
    ...
    sLIM=[-10;10];    
    [TETd,SDL,dDLf]=FCONTROL1(DL,DL0,SDL0,dDLf0,sLIM,kP,kI,kD);    
    DL0=DL; SDL0=SDL; dDLf0=dDLf;
    % Вычисление требуемого значения угла крена
    kP=5.0;    kI=1.0;    kD=6.0;
    sLIM=[-10;10];
    [GAMd,SDZ,dDZf]=FCONTROL1(DZ,DZ0,SDZ0,dDZf0,sLIM,kP,kI,kD);
    ...
    [UH,SDH,dDHf]=FCONTROL1(DH,DH0,SDH0,dDHf0,sLIM,kP,kI,kD);
    DH0=DH; SDH0=SDH;   dDHf0=dDHf;
    
    %% Канал тангажа
    %kP=32.918371; kI=-0.000025; kD=2.360600;
    %kP=14.48; kI=-0.05; kD=4.29;
    kP=0.07; kI=0.001; kD=0.03;
    sLIM=[-90;90]*pi/180;
      [UTET,SDTET,dDTETf]=FCONTROL1(DTET,DTET0,SDTET0,dDTETf0,sLIM,kP,kI,kD);
    ...
    sLIM=[-90;90]*pi/180;
    [UGAM,SDGAM,dDGAMf]=FCONTROL1(DGAM,DGAM0,SDGAM0,dDGAMf0,sLIM,kP,kI,kD);
    ...
    sLIM=[-90;90]*pi/180;
    [UPSI,SDPSI,dDPSIf]=FCONTROL1(DPSI,DPSI0,SDPSI0,dDPSIf0,sLIM,kP,kI,kD);
...
function [U]=CONTROL1(U0,X,Xd,TIME)
global  PARAM INVAFM
kT = PARAM.kT;   % коэффициент тяги 
Lq = PARAM.Lq;   % Плечо
kM = PARAM.kM;   % коэффициент момента
